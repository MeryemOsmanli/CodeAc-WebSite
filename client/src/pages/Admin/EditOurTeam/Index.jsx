...
import { getOneOurTeam, postOurTeam, updateOurTeam } from '../../../redux/slices/ourTeamSlice';
...
const EditOurTeam = () => {
    ...
    const { oneOurTeam } = useSelector(state => state.ourTeam)
    const { id } = useParams()
    useEffect(() => {
        formik.setValues({
            image: oneOurTeam.image,
            title: oneOurTeam.title,
            content: oneOurTeam.content,
        })
    }, [oneOurTeam])
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            dispatch(updateOurTeam({ id: oneOurTeam?._id, newData: values }));
            formik.resetForm()
                                ...
                                <div className="addManagementInsideCardBox">
                                    ...
                                    <form onSubmit={formik.handleSubmit}>
                                        <div className="addManagementFormItem ">
                                            <label htmlFor="ourTeamTitleE">Team Title</label>
                                            <input
                                                onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.title}
                                                name='title'
                                                type="text" id='ourTeamTitleE' placeholder='Enter Team Title' />
                                        ...
                                        <div className="addManagementFormItem ">
                                            <label htmlFor="managementProfessionE">Team Profession</label>
                                            <input
                                                onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.content}
                                                name='content'
                                                type="text" id='managementProfessionE' placeholder='Enter Team Profession' />
                                            {formik.touched.content && formik.errors.content ? (
                                                <div className='testimonialError'>{formik.errors.content}</div>
                                            ) : null}
                                        </div>
                                        <div className="addManagementFormItem ">
                                            <label htmlFor="teamImageE">Team Image</label>
                                            <input
                                                onChange={formik.handleChange}
                                                onBlur={formik.handleBlur}
                                                value={formik.values.image}
                                                name='image'
                                                type="text" id='teamImageE' placeholder='Enter Team Image' />
